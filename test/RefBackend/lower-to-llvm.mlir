// RUN: cancer-opt -refback-lower-to-llvm -split-input-file <%s | FileCheck %s --dump-input=fail
...
// CHECK:           llvm.return
// CHECK:         }
// CHECK:         llvm.func @__cancer_compiler_rt_abort_if(i1, !llvm.ptr<i8>)
// CHECK:         llvm.mlir.global internal constant @__cancer_internal_constant_inputs1results0("inputs1results0")
// CHECK:         llvm.mlir.global internal constant @__cancer_internal_constant_inputs1results1("inputs1results1")
// CHECK:         llvm.mlir.global internal constant @__cancer_internal_constant_inputs1results2("inputs1results2")

// CHECK-LABEL:   llvm.mlir.global internal constant @__cancer_func_descriptors() : !llvm.array<3 x struct<(i32, ptr<i8>, ptr<i8>, i32, i32)>> {
...
// CHECK:           %[[VAL_4:.*]] = llvm.mlir.addressof @__cancer_internal_constant_inputs1results0 : !llvm.ptr<array<15 x i8>>
...
// CHECK:           %[[VAL_16:.*]] = llvm.mlir.addressof @__cancer_internal_constant_inputs1results1 : !llvm.ptr<array<15 x i8>>
...
// CHECK:           %[[VAL_28:.*]] = llvm.mlir.addressof @__cancer_internal_constant_inputs1results2 : !llvm.ptr<array<15 x i8>>
...
// CHECK-LABEL:   llvm.mlir.global external constant @_mlir___cancer_module_descriptor() : !llvm.struct<(i32, ptr<struct<(i32, ptr<i8>, ptr<i8>, i32, i32)>>)> {
...
// CHECK:           %[[VAL_3:.*]] = llvm.mlir.addressof @__cancer_func_descriptors : !llvm.ptr<array<3 x struct<(i32, ptr<i8>, ptr<i8>, i32, i32)>>>
...
// CHECK:         llvm.call @__cancer_compiler_rt_abort_if(%[[VAL_3:.*]], %[[VAL_2]]) : (i1, !llvm.ptr<i8>) -> ()
// CHECK:         llvm.return
