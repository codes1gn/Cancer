...
//===----------------------------------------------------------------------===//
//
// This is the public-facing interface for interacting with the cancer
// runtime.
//
...
//
// cancer/RefBackend/Runtime/Support.h provides some minimal LLVM-like support
// code to keep the API familiar.
//
//===----------------------------------------------------------------------===//

#ifndef CANCER_RUNTIME_USERAPI_H
#define CANCER_RUNTIME_USERAPI_H
...
#define CANCER_FORALL_PRIM_TAGS(_)                                             \
  _(None)                                                                      \
  _(Bool)                                                                      \
  _(Int)                                                                       \
  _(Float)                                                                     \
...
#define CANCER_FORALL_REF_TAGS(_) _(Tensor)

#define CANCER_FORALL_TAGS(_)                                                  \
  CANCER_FORALL_PRIM_TAGS(_)                                                   \
  CANCER_FORALL_REF_TAGS(_)
...
#define DEFINE_IS_REF(x)                                                       \
  if (is##x()) {                                                               \
    ...
    CANCER_FORALL_REF_TAGS(DEFINE_IS_REF)
#undef DEFINE_IS_REF
    return false;
  }
...
#define DEFINE_CASE(x)                                                         \
  case Tag::x:                                                                 \
    return #x;
      CANCER_FORALL_TAGS(DEFINE_CASE)
#undef DEFINE_CASE
    }
...
#define DEFINE_INCREF(x)                                                       \
  if (is##x()) {                                                               \
    ...
    return;                                                                    \
      ...
      CANCER_FORALL_REF_TAGS(DEFINE_INCREF)
#undef DEFINE_INCREF
...
#define DEFINE_DECREF(x)                                                       \
  if (is##x()) {                                                               \
    ...
    return;                                                                    \
      ...
      CANCER_FORALL_REF_TAGS(DEFINE_DECREF)
#undef DEFINE_DECREF
      assert(false && "Unsupported RtValue type");
    }
  }
...
#endif // CANCER_RUNTIME_USERAPI_H
